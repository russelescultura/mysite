...
<html lang="en">
    ...
    <h2>Seminars List</h2>
    <h2 class="mb-4"></h2>
    <a href="add_seminar.php" class="btn btn-primary mb-3">Add Seminar</a>
    <table class="table table-striped table-hover">
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    $description = implode(' ', array_slice(explode(' ', $row["description"]), 0, 5));
                    ...
                    echo "<tr>
                        ...
                        <td>".htmlspecialchars($row["seminar_name"])."</td>
                        <td>".htmlspecialchars($row["conductor"])."</td>
                        <td>".htmlspecialchars($row["seminar_year"])."</td>
                        <td>".htmlspecialchars($row["seminar_month"])."</td>
                        <td>".htmlspecialchars($description)."</td>
                        <td>
                            <a href='view_seminar.php?id=".$row["id"]."' class='btn btn-sm btn-info'>
                                <i class='fas fa-eye'></i>
                            </a>
                            <a href='edit_seminar.php?id=".$row["id"]."' class='btn btn-sm btn-warning'>
                                <i class='fas fa-edit'></i>
                            </a>
                            <a href='delete_seminar.php?id=".$row["id"]."' class='btn btn-sm btn-danger' onclick='return confirm(\"Are you sure?\")'>
