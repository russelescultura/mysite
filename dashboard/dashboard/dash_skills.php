...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <a href="add_skills.php" class="btn btn-primary mb-3">Add New Skill</a>
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        echo "<tr>
                            ...
                            <td>
                              <a href='edit_skills.php?id=" . $row["id"] . "' class='btn btn-sm btn-warning'>
                                        <i class='fas fa-edit'></i>
                                    </a>
                                <a href='delete_skills.php?id=" . $row["id"] . "' class='btn btn-sm btn-danger' onclick='return confirm(\"Are you sure?\")'>
