...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div class="container mt-5">
            ...
            <a href="add_education.php" class="btn btn-primary mb-3">Add New Record</a>
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            echo "<tr>
                                <td>" . htmlspecialchars($row["year_started"]) . "</td>
                                <td>" . htmlspecialchars($row["year_ended"]) . "</td>
                                <td>" . htmlspecialchars($row["school_name"]) . "</td>
                                <td>" . htmlspecialchars($row["school_level"]) . "</td>
                                <td>
                                    <a href='view_education.php?id=" . $row["id"] . "' class='btn btn-sm btn-info'>
                                        <i class='fas fa-eye'></i>
                                    </a>
                                    <a href='edit_education.php?id=" . $row["id"] . "' class='btn btn-sm btn-warning'>
                                        <i class='fas fa-edit'></i>
                                    </a>
                                    <a href='delete_education.php?id=" . $row["id"] . "' class='btn btn-sm btn-danger' onclick='return confirm(\"Are you sure?\")'>
